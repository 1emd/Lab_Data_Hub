...
Для облегчения управления данными в проекте предусмотрена административная панель. Для доступа к ней, необходимо создать суперпользователя и перейти по следующей ссылке: 
    ```
